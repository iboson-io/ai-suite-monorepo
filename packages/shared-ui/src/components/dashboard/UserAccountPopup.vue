<template>
  <Teleport to="body">
    <div
      v-if="open"
      class="fixed inset-0 z-[100] lg:inset-auto lg:top-0 lg:bottom-0 lg:right-0"
    ...
    <div
      v-if="open"
      class="fixed z-[101] bg_secondary_color shadow-sm border primary_border_color bottom-[4.4em] lg:inset-auto lg:top-auto popup_position lg:rounded-xl px-4 py-4"
      :class="[
