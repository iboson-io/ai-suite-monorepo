    ...
    <div class="flex-1 flex flex-col min-h-0">
      ...
      <div v-else class="flex-1 bg-white rounded-xl p-8 flex lg:flex-row flex-col gap-8 min-h-0 overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-h-0">
          ...
          <PhoneCustomizationForm
            v-else-if="activeTab === 'phone'"
            v-model:voiceStyle="voiceStyle"
            v-model:voiceGreeting="voiceGreeting"
            @save="savePhoneSettings"
          />
          ...
          <SdkIntegrationForm
            ...
            @copy="copyToClipboard(sdkSnippet, 'sdk')"
          />
        ...
        <div class="flex-1 w-full bg-info-50 rounded-2xl flex flex-col items-center justify-center relative shadow-inner overflow-hidden min-h-[400px]">
          <PhonePreviewWidget
...
import PhoneCustomizationForm from './setup/PhoneCustomizationForm.vue'
...
import PhonePreviewWidget from './setup/PhonePreviewWidget.vue'
...
// Phone / Call Mock Settings
const voiceStyle = ref('amber')
const voiceGreeting = ref('Hello, thank you for calling. How can I assist you with your request today?')
...
// Call Integrations Placeholder
function savePhoneSettings() {
  showToast('Success', 'Phone calling integration saved successfully')
}
