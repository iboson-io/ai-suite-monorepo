<template>
  <div class="flex-1 bg_primary_color px-3xl py-12xl md:px-10xl lg:py-10xl">
    <div class="w-full flex mx-auto flex-col min-h-0 h-full">
      <!-- Loading -->
      <div
        v-if="!productData"
      ...
      <template v-else>
        <button
          type="button"
          class="ml-6xl label_2_medium primary_text_color hover:underline mb-6xl text-left w-fit"
          @click="$emit('back')"
        >
          &lt; Back to products
        </button>
        ...
        <div class="flex-1 mt-6xl min-h-0 w-full">
        ...
        >
          <button
            type="button"
            class="inline-flex items-center gap-md rounded-lg border primary_border_color bg-gray-25 px-5xl py-xl label_2_semibold md:label_1_semibold primary_text_color hover:bg-gray-50 disabled:opacity-50"
          ...
          <button
            type="button"
            class="flex items-center gap-md rounded-lg px-5xl py-xl modal_primary_button cursor-pointer label_2_semibold md:label_1_semibold disabled:opacity-50"
...
import ProductUpdateSuccessModal from "./ProductUpdateSuccessModal.vue";
